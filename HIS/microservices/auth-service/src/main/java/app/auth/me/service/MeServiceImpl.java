...
public class MeServiceImpl implements MeService {
    ...
    public AuthUserInfo getCurrentUserInfo(String username) {
        ...
        AuthAccount account = authAccountRepository.findByUsernameIgnoreCase(normalizedUsername).orElse(null);
    ...
    public void changeMyPassword(String username, ChangePasswordRequest request) {
        ...
        String normalizedUsername = normalizeUsername(username);
        AuthAccount account = authAccountRepository.findByUsernameIgnoreCase(normalizedUsername)
