...
public class ConsentController {
    ...
    public ResponseEntity<ApiResponse<List<ConsentResDTO>>> findList(@PathVariable Long patientId) {
        log.info("Controller: GET /api/patients/{}/consents", patientId);
    ...
    public ResponseEntity<ApiResponse<ConsentResDTO>> findDetail(
        ...
        log.info("Controller: GET /api/patients/{}/consents/{}", patientId, consentId);
    ...
    public ResponseEntity<ApiResponse<ConsentResDTO>> register(
        ...
        log.info("Controller: POST /api/patients/{}/consents", patientId);
    ...
    public ResponseEntity<ApiResponse<ConsentResDTO>> modify(
        ...
        log.info("Controller: PUT /api/patients/{}/consents/{}", patientId, consentId);
    ...
    public ResponseEntity<ApiResponse<Void>> remove(
        ...
        log.info("Controller: DELETE /api/patients/{}/consents/{}", patientId, consentId);
