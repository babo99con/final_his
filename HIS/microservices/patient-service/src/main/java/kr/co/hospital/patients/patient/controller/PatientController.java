...
import kr.co.hospital.patients.patient.dto.PatientIdentifyReqDTO;
import kr.co.hospital.patients.patient.dto.PatientIdentifyResDTO;
import kr.co.hospital.patients.patient.dto.PatientResDTO;
import kr.co.hospital.patients.patient.dto.StatusChangeReqDTO;
import kr.co.hospital.patients.patient.dto.UpdateReqDTO;
import kr.co.hospital.patients.patient.dto.VipChangeReqDTO;
...
public class PatientController {
    ...
    public ResponseEntity<ApiResponse<List<PatientResDTO>>> findList() {
        log.info("Controller: GET /api/patients");
    ...
    public ResponseEntity<ApiResponse<PatientResDTO>> findDetail(@PathVariable Long patientId) {
        log.info("Controller: GET /api/patients/{}", patientId);
    ...
    public ResponseEntity<ApiResponse<PatientResDTO>> register(
        ...
        log.info("Controller: POST /api/patients");
    ...
    public ResponseEntity<ApiResponse<PatientResDTO>> modify(
        ...
        log.info("Controller: PUT /api/patients/{}", patientId);
    ...
    public ResponseEntity<ApiResponse<Void>> remove(@PathVariable Long patientId) {
        log.info("Controller: DELETE /api/patients/{}", patientId);
    ...
    public ResponseEntity<ApiResponse<PatientResDTO>> changeStatus(
        ...
        log.info("Controller: PUT /api/patients/{}/status", patientId);
    ...
    public ResponseEntity<ApiResponse<PatientResDTO>> changeVip(
        ...
        log.info("Controller: PUT /api/patients/{}/vip", patientId);
    ...
    @Operation(summary = "Identify patients", description = "Identify possible duplicate patients.")
    @PostMapping("/identify")
    public ResponseEntity<ApiResponse<List<PatientIdentifyResDTO>>> identify(
            @RequestBody PatientIdentifyReqDTO reqDTO
    ) {
        List<PatientIdentifyResDTO> list = service.identify(reqDTO);
        return ResponseEntity.ok(new ApiResponse<>(true, "OK", list));
    }
}
